    ...
    <div className="w-full px-5">
      ...
      <div className="w-full bg-white h-[70px] rounded-[4px] flex items-center px-3 shadow justify-between pr-10">
        <div className="flex items-center">
          <img
            src="https://bonik-react.vercel.app/assests/images/payment-methods/Visa.svg"
            alt=""
          />
          <h5 className="pl-5 font-[600] ">Sana Y.</h5>
        </div>
        <div className="pl-8 flex items-center">
          <h6>1234 **** *** ****</h6>
          <h5 className="pl-8">08/2025</h5>
        </div>
        <div className="min-w-[10%] flex items-center justify-between p-8">
  ...
  return (
    <div className="w-full px-5">
      ...
      <div className="w-full bg-white h-[70px] rounded-[4px] flex items-center px-3 shadow justify-between pr-10">
        ...
        <div className="pl-8 flex items-center">
          <h6>494 Erdman Pasaage, New Jersey, Paraguay</h6>
        </div>
        <div className="pl-8 flex items-center">
          <h6>(213) 840-9416</h6>
        </div>
